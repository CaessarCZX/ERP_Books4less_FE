...
const sections = [
    { 
        ...
        inputs: ["Información de la orden de compra", "Fecha de la orden de compra"] 
    },
    { 
        title: "Información del Vendedor", 
        inputs: ["Nombre del vendedor", "P.O del vendedor", "Dirección del vendedor"] 
    },
    { 
        title: "Información del Envío", 
        inputs: ["Nombre de la empresa", "Dirección de la empresa", "Datos de la empresa"] 
    },
    { 
