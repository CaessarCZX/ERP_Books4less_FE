...
const Header = () => {
  return (
    <>
      <nav navbar-main className="relative flex flex-wrap w-full items-center justify-between  px-0 py-2  mt-1 transition-all shadow-none duration-250 ease-soft-in rounded-2xl lg:flex-nowrap lg:justify-start" navbar-scroll="true">
