...
const TableRow: FC<UploadFile> = ({ filename, type, actions, date, size }) => {
  ...
  return (
    <tr>
      <td className="overflow-x-scroll px-3 py-2 md:px-6 md:py-4 md:whitespace-nowrap">
        <div className="flex items-center">
          ...
          {/* --- icon --- */}
          <div className="ml-4 max-w-12 md:max-w-20 xl:max-w-full">
            <div className="text-[10px] font-medium text-gray-900 md:text-sm">
              {filename}
            </div>
      ...
      <td className="px-3 py-2 whitespace-nowrap md:px-6 md:py-4">
      ...
      <td className="px-3 py-2 text-right text-sm font-medium whitespace-nowrap md:px-6 md:py-4">
